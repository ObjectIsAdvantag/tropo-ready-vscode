...
function help() {
    console.log("Usage: tropocheck [--script] <your-script.js>\n");
    console.log("Simulates a Tropo runtime environment to quickly check for obvious inconsistencies (syntax error, bad arguments to Tropo function...)");
    console.log("by default, starts the specified script in the context of a Tropo Inbound Voice call\n");
    console.log("To create an Outbound SMS call, try: tropocheck <your-script.js> --outbound --SMS \n");
    console.log('To pass parameters, try: tropocheck <your-script.js> --parameters "phonenumber=+33678007800" "msg=Hello world!" \n');
    console.log("   -c, --callerID '+33678007835' : sets the callerID for Inbound calls. Ignored if the call is Outbound.");
